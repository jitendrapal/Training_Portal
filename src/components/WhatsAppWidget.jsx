...
const WhatsAppWidget = () => {
  ...
  const whatsappNumber = "+918055006652"; // Replace with your actual WhatsApp number
  ...
  const quickMessages = [
    ...
    },
    {
      ...
      message:
        "Hi! I'd like to schedule a call with an admission counselor to discuss the courses and my career goals.",
    },
  ];
