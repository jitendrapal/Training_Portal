...
const Courses = () => {
  ...
  const courses = [
    ...
    },
    {
      ...
      description:
        "Master C#, ASP.NET Core, Entity Framework, and modern web development. Build scalable enterprise applications.",
      duration: "6 Months",
      schedule: "2 Hours/Day",
      technologies: [
        "C#",
    ...
    },
    {
      ...
      description:
        "Learn fundamental programming concepts with C and advanced object-oriented programming with C++.",
      duration: "4 Months",
      schedule: "2 Hours/Day",
      technologies: [
        "C Programming",
    ...
    },
    {
      ...
      description:
        "Master PHP, Laravel, MySQL, and web development. Build dynamic websites and web applications.",
      duration: "4 Months",
      schedule: "2 Hours/Day",
    ...
    },
    {
      ...
      description:
        "Dive into Artificial Intelligence and Machine Learning with Python. Build intelligent applications and models.",
      duration: "6 Months",
      schedule: "2 Hours/Day",
    ...
    },
    {
      ...
      description:
        "Master front-end web development with HTML5, CSS3, and jQuery. Create responsive and interactive websites.",
      duration: "3 Months",
      schedule: "2 Hours/Day",
      technologies: [
        "HTML5",
    ...
    },
    {
      ...
      description:
        "Build mobile applications for Android and iOS platforms. Learn native and cross-platform development.",
      duration: "5 Months",
      schedule: "2 Hours/Day",
      technologies: [
        "Java/Kotlin",
