...
const ServiceEnrollmentForm = () => {
  ...
  const validateField = (name, value) => {
    switch (name) {
      ...
      case "service":
        if (!value.trim()) return "Service selection is required";
        return "";
  ...
  useEffect(() => {
    ...
    // Check if we need to scroll to form (from service buttons)
    if (location.state?.scrollToForm) {
      setTimeout(() => {
        const element = document.getElementById("service-enroll");
        if (element) {
  ...
  const handleSubmit = useCallback(
    async (e) => {
      ...
      try {
        ...
        // Using 'service' form type
        submitToGoogleSheets(formData, FORM_CONFIG.FORM_TYPES.SERVICE);
          ...
          <div className="bg-white rounded-2xl p-12 shadow-xl">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
              ...
              <p className="text-green-700 text-sm mt-1">
                Meanwhile, check your email for service details and next steps.
              </p>
            </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-primary-100 mb-8">
              Get started with our professional IT services. Fill out the form
              and receive a free consultation with our experts.
            </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-primary-100 text-sm">
                    Tailored services designed for your specific requirements
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-primary-100 text-sm">
                    Get the best value with our flexible pricing options
                  </p>
                </div>
              </div>
            ...
            <div className="mt-8 p-6 bg-white/10 backdrop-blur-sm rounded-lg">
              ...
              <p className="text-primary-100 text-sm">
                Contact us this month and get <strong>15% off</strong> on your
                first project + Free consultation + Priority support
              </p>
            </div>
          </div>
...
export default ServiceEnrollmentForm;
