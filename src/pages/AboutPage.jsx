          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-primary-50 p-8 rounded-2xl flex flex-col items-center text-center">
              ...
              <a
                ...
                className="mt-4 inline-flex items-center justify-center rounded-full bg-blue-100 text-blue-700 hover:bg-blue-200 hover:text-blue-900 p-3 transition-colors"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
