...
const JavaLanding = () => {
  const structuredData = {
    ...
    description:
      "Practical Java Full Stack training with Spring Boot, React, PostgreSQL, Docker, live projects, and internship support to make you job-ready.",
    provider: {
      "@type": "Organization",
  ...
  return (
    <div className="pt-24">
      <SEO
        title="Java Full Stack Course | Job-Ready Training with Internship"
        description="Join our Java Full Stack program with Spring Boot, React, Docker, PostgreSQL, live projects, internship support, and placement coaching."
        keywords="Java Full Stack Course, Spring Boot training, Java internship, Full Stack Java, Java jobs, Java course Pune"
      ...
      <section className="bg-gradient-to-r from-sky-600 to-primary-600 text-white py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Java Full Stack Development — Job-Ready in 6 Months
          </h1>
