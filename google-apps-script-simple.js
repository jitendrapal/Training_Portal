/**
 * SIMPLE Google Apps Script for TechAcademy Enrollment Form
...
function doPost(e) {
  try {
    ...
    if (sheet.getLastRow() === 0) {
      const headers = ['Timestamp', 'Name', 'Email', 'Phone', 'Course', 'Message', 'Source', 'Status'];
...
function doGet(e) {
  ...
  return ContentService.createTextOutput('TechAcademy Form Handler is working! Use POST to submit data.');
}
